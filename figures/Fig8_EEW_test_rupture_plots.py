...
rupt_files = [f'{home}/ONC-EEW/simulations/cascadia/output/ruptures/cascadia-000015.rupt',
              f'{home}/ONC-EEW/simulations/cascadia/output/ruptures/cascadia-000018.rupt',
              f'{home}/ONC-EEW/simulations/cascadia/output/ruptures/cascadia-000051.rupt',
              f'{home}/ONC-EEW/simulations/cascadia/output/ruptures/cascadia-000065.rupt',
              f'{home}/ONC-EEW/simulations/cascadia/output/ruptures/cascadia-000096.rupt',
              f'{home}/ONC-EEW/simulations/cascadia/output/ruptures/cascadia-000108.rupt']
...
for rupt_file in rupt_files:
    ...
    f = open(f'{home}/ONC-EEW/GMT/plotting_files/rupture_epi/{batch}/{run}_epi.txt', 'w')
    f.write(f'{lon},{lat}')
    f.close()
