...
fig, axs = plt.subplot_mosaic(layout, figsize=(6.3,6), gridspec_kw={'height_ratios':[1.25,0.2,1.5]})
...
# Magnitude vs SNR
combined_snr = np.concatenate((snr_10p[dist_ind], snr_50p[dist_ind], snr_90p[dist_ind]))
shuffled_indices = np.random.permutation(len(combined_snr))
combined_M = np.concatenate((M[dist_ind], M[dist_ind], M[dist_ind]))[shuffled_indices]
combined_shapes = np.concatenate((M[dist_ind], M[dist_ind], M[dist_ind]))[shuffled_indices]
axs['C'].scatter(snr_10p[dist_ind], M[dist_ind], s=15, marker='o', lw=0.5, facecolors='none', edgecolors='darkorchid', alpha=0.6, label='10p Noise')
axs['C'].scatter(snr_50p[dist_ind], M[dist_ind], s=15, marker='^', lw=0.5, facecolors='none', edgecolors='mediumturquoise', alpha=0.6, label='50p Noise')
axs['C'].scatter(snr_90p[dist_ind], M[dist_ind], s=15, marker='s', lw=0.5, facecolors='none', edgecolors='goldenrod', alpha=0.6, label='90p Noise')
...
axs['C'].set_xlabel('SNR')

# Magnitude vs PGD residual
axs['D'].scatter(snr_90p[dist_ind], pgd_res_gold_90p[dist_ind], s=15, marker='s', lw=0.5, facecolors='none', edgecolors='goldenrod', alpha=0.6, label='90th perc')
axs['D'].scatter(snr_50p[dist_ind], pgd_res_gold_50p[dist_ind], s=15, marker='^', lw=0.5, facecolors='none', edgecolors='mediumturquoise', alpha=0.6, label='50th perc')
axs['D'].scatter(snr_10p[dist_ind], pgd_res_gold_10p[dist_ind], s=15, marker='o', lw=0.5, facecolors='none', edgecolors='darkorchid', alpha=0.6, label='10th perc')
